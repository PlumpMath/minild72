...
pong.fairydust.paddles_size = (function pong$fairydust$paddles_size(state){
...
if(((new cljs.core.Keyword(null,"h","h",1109658740).cljs$core$IFn$_invoke$arity$1(paddle_player) > pong.setup.pb_width)) && (cljs.core._EQ_.call(null,cljs.core.mod.call(null,quil.core.frame_count.call(null),(pong.setup.frame_rate * (10))),(0)))){
...
return pong.fairydust.paddles_color.call(null,pong.fairydust.paddles_size.call(null,state));
});
