...
var paddle_height = new cljs.core.Keyword(null,"h","h",1109658740).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"paddle","paddle",35445907).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"player","player",-97687400).cljs$core$IFn$_invoke$arity$1(state)));
var y_middle = (y - (paddle_height / (2)));
var y_clamped = pong.util.clamp.call(null,y_middle,(0),(court_height - paddle_height));
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"player","player",-97687400),new cljs.core.Keyword(null,"paddle","paddle",35445907),new cljs.core.Keyword(null,"y","y",-1757859776)], null),y_clamped);
});
