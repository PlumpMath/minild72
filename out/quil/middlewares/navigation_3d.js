...
var vec__13552 = axis;
var a_x = cljs.core.nth.call(null,vec__13552,(0),null);
var a_y = cljs.core.nth.call(null,vec__13552,(1),null);
var a_z = cljs.core.nth.call(null,vec__13552,(2),null);
var vec__13555 = v;
var x = cljs.core.nth.call(null,vec__13555,(0),null);
var y = cljs.core.nth.call(null,vec__13555,(1),null);
var z = cljs.core.nth.call(null,vec__13555,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__13558,p__13559){
var vec__13566 = p__13558;
var u1 = cljs.core.nth.call(null,vec__13566,(0),null);
var u2 = cljs.core.nth.call(null,vec__13566,(1),null);
var u3 = cljs.core.nth.call(null,vec__13566,(2),null);
var vec__13569 = p__13559;
var v1 = cljs.core.nth.call(null,vec__13569,(0),null);
var v2 = cljs.core.nth.call(null,vec__13569,(1),null);
var v3 = cljs.core.nth.call(null,vec__13569,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__13572_SHARP_){
return (p1__13572_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__13573_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__13574_SHARP_,angle_lr),angle_ud);
...
var map__13581 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__13581__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__13581__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__13583 = cljs.core._EQ_;
var expr__13584 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__13583.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__13584))){
return straight;
} else {
if(cljs.core.truth_(pred__13583.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__13584))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__13583.call(null,quil.middlewares.navigation_3d.space,expr__13584))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__13583.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__13584))){
return up;
} else {
if(cljs.core.truth_(pred__13583.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__13584))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__13583.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__13584))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__13581,map__13581__$1,up,straight){
return (function (p1__13575_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__13575_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__13581,map__13581__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__13586_SHARP_);
});})(initial_state))
);
});
/**
...
var map__13598_13609 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__13598_13610__$1 = ((((!((map__13598_13609 == null)))?((((map__13598_13609.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13598_13609.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13598_13609):map__13598_13609);
var vec__13599_13611 = cljs.core.get.call(null,map__13598_13610__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_13612 = cljs.core.nth.call(null,vec__13599_13611,(0),null);
var c_y_13613 = cljs.core.nth.call(null,vec__13599_13611,(1),null);
var c_z_13614 = cljs.core.nth.call(null,vec__13599_13611,(2),null);
var vec__13602_13615 = cljs.core.get.call(null,map__13598_13610__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_13616 = cljs.core.nth.call(null,vec__13602_13615,(0),null);
var u_y_13617 = cljs.core.nth.call(null,vec__13602_13615,(1),null);
var u_z_13618 = cljs.core.nth.call(null,vec__13602_13615,(2),null);
var vec__13605_13619 = cljs.core.get.call(null,map__13598_13610__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_13620 = cljs.core.nth.call(null,vec__13605_13619,(0),null);
var p_y_13621 = cljs.core.nth.call(null,vec__13605_13619,(1),null);
var p_z_13622 = cljs.core.nth.call(null,vec__13605_13619,(2),null);
quil.core.camera.call(null,p_x_13620,p_y_13621,p_z_13622,(p_x_13620 + c_x_13612),(p_y_13621 + c_y_13613),(p_z_13622 + c_z_13614),u_x_13616,u_y_13617,u_z_13618);
